  ...
  const navigationItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          label: "回覧履歴",
          href: "/circulations?tab=completed",
          icon: "history",
        },
        {
          label: "ワークフロー",
          href: "/circulations/workflows",
          icon: "workflow",
        },
      ],
    },
          ...
          <div class="relative">
            {#if item.children}
              ...
              >
                ...
                <svg
                  class="ml-3 h-4 w-4 transition-transform duration-200 {expandedItems.has(
                    item.href,
                  )
                    ? 'rotate-90'
                    : ''}"
