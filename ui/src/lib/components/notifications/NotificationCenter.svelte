...
<div class="relative">
  ...
  {#if showNotifications}
    <div class="origin-top-right absolute right-0 mt-2 w-96 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
      <div class="py-1">
        <!-- ヘッダー -->
        ...
        <div class="max-h-96 overflow-y-auto">
              ...
              <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 {!notification.read ? 'bg-blue-50' : ''}">
                <div class="flex">
                  ...
                  <div class="flex-shrink-0">
                    <svg class="h-6 w-6 {getNotificationColor(notification.type)}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                  ...
                  <div class="ml-3 flex-1">
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
                        ...
                        <p class="mt-1 text-xs text-gray-500">{notification.timestamp}</p>
                          ...
                          <div class="mt-2 flex space-x-2">
                            {#each notification.actions as action}
                              <button
                                ...
                                on:click={() => executeAction(notification.id, action.action)}
                              >
                                {action.label}
                              </button>
                            {/each}
          ...
          {:else}
            <div class="px-4 py-8 text-center">
              ...
              <p class="mt-1 text-sm text-gray-500">新しい通知があるとここに表示されます。</p>
            </div>
          {/if}
        </div>
        ...
        {#if notifications.length > 0}
          <div class="px-4 py-3 border-t border-gray-200">
            <a href="/notifications" class="text-sm text-blue-600 hover:text-blue-900 font-medium">
              すべての通知を表示
            </a>
          </div>
        {/if}
