<script lang="ts">
  ...
  export let onSort: ((key: string, direction: string) => void) | undefined =
    undefined;
        ...
        {#each headers as header}
          ...
          >
            <div class="flex items-center space-x-1">
              ...
              {#if header.sortable}
                <svg
                  class="w-4 h-4 text-gray-400 {sortColumn === header.key
                    ? 'text-gray-600'
                    : ''}"
                  class:rotate-180={sortColumn === header.key &&
                    sortDirection === "desc"}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
    ...
    <slot name="empty">
      ...
      >
        <path
          ...
          stroke-linejoin="round"
          stroke-width="2"
          d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m4-8v12m4-8v8"
        />
      </svg>
