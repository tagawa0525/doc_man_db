  ...
  <div class="bg-white shadow rounded-lg">
    ...
    {:else if notifications.length === 0}
      <div class="px-6 py-12 text-center">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">通知履歴がありません</h3>
        <p class="mt-1 text-sm text-gray-500">送信された通知があるとここに表示されます。</p>
      </div>
    {:else}
              ...
              <tr class="hover:bg-gray-50">
                <td class="px-6 py-4">
                  <div class="space-y-1">
                    ...
                    <div>
                      <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getStatusColor(notification.status)}">
                ...
                <td class="px-6 py-4">
                  ...
                  {#if notification.templateId}
                    <div class="text-xs text-gray-500">テンプレート: {notification.templateId}</div>
                  {/if}
                </td>
                <td class="px-6 py-4">
                  <div class="text-sm font-medium text-gray-900">{notification.subject}</div>
                  <div class="text-sm text-gray-500 truncate max-w-xs">{notification.content}</div>
                </td>
