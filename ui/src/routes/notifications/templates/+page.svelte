      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
        {#each templates as template}
          ...
          >
            ...
            <!-- 件名 -->
            <div class="mb-3">
              <div class="block text-xs font-medium text-gray-500 mb-1">
                件名
              </div>
                ...
                <div class="flex flex-wrap gap-1">
                  ...
                  {#if template.variables.length > 3}
                    <span class="text-xs text-gray-500"
                      >+{template.variables.length - 3}個</span
                    >
                  {/if}
                </div>
              </div>
      ...
      <div class="mt-3">
        ...
        <form on:submit|preventDefault={saveTemplate} class="space-y-4">
          ...
          <div>
            ...
            />
            <p class="mt-1 text-xs text-gray-500">
              利用可能な変数: documentTitle, documentNumber, requesterName,
              createdDate, approvalUrl など
            </p>
          </div>
          ...
          <div class="flex justify-end space-x-3 pt-4">
            <Button type="button" variant="secondary" on:click={closeModals}>
              キャンセル
            </Button>
