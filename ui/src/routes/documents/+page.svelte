        ...
        <div class="border-t border-gray-200 pt-4">
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">社内外区分</label>
                <Select
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">重要度</label>
                <Select
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">個人情報</label>
                <Select
  ...
  <div class="bg-white shadow rounded-lg">
      ...
      <div class="flex justify-between items-center">
        ...
        {#if totalCount > 0}
          <div class="flex items-center space-x-2">
            <label for="sort" class="text-sm font-medium text-gray-700">並び順:</label>
            <select 
              id="sort" 
    ...
    {:else if documents.length === 0}
      <div class="px-6 py-12 text-center">
        ...
        <p class="mt-1 text-sm text-gray-500">検索条件に一致する文書が見つかりませんでした。</p>
      </div>
    {:else}
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            {#each documents as document}
              <tr class="hover:bg-gray-50">
                <td class="px-6 py-4">
                  <div>
                    <div class="text-sm font-medium text-gray-900">{document.number}</div>
                    <div class="text-sm text-gray-500">{document.title}</div>
                    {#if document.businessNumber}
                      <div class="text-xs text-blue-600">業務番号: {document.businessNumber}</div>
                    {/if}
                  </div>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getConfidentialityColor(document.confidentiality)}">
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center space-x-2">
                    <div class="flex items-center">
                      <div class="h-2 w-2 rounded-full {document.hasFile ? 'bg-green-400' : 'bg-red-400'} mr-1"></div>
                      <span class="text-xs text-gray-600">ファイル</span>
                    </div>
                    <div class="flex items-center">
                      <div class="h-2 w-2 rounded-full {document.hasApproval ? 'bg-green-400' : 'bg-red-400'} mr-1"></div>
