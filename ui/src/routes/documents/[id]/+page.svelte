<script lang="ts">
  ...
  async function loadDocument() {
    ...
    try {
      ...
      const doc = documentId ? mockDocuments[documentId] : null;
      if (!doc) {
...
<div class="space-y-6">
  ...
  {:else if error}
    ...
    <div class="text-center py-12">
      ...
      <div class="mt-6">
        <Button variant="primary" on:click={loadDocument}>再読み込み</Button>
      </div>
    </div>
  {:else if document}
    <!-- 文書詳細 -->
    ...
    <div class="md:flex md:items-center md:justify-between">
      <div class="min-w-0 flex-1">
        <div class="flex items-center">
          ...
          <span
            class="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border {getConfidentialityColor(
          ...
          <div class="mt-2 flex items-center text-sm text-gray-500">
            ...
            >
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V7h6V3a2 2 0 00-2-2H10a2 2 0 00-2 2v4z"
              />
            </svg>
        ...
        <div class="bg-white shadow rounded-lg p-6">
          ...
          {#if document.notes}
            <div class="mt-6">
              ...
              <dd class="mt-2 text-sm text-gray-900 whitespace-pre-wrap">
                {document.notes}
              </dd>
            </div>
          {/if}
            ...
            <div class="border rounded-lg p-4">
              <div class="flex items-center justify-between mb-2">
                ...
                <div class="flex items-center">
                  ...
                  ></div>
                  <span class="text-xs text-gray-600"
                    >{document.hasApproval ? "存在" : "不存在"}</span
                  >
                </div>
              </div>
              <p class="text-xs text-gray-500 mb-3">
                {document.hasApproval
                  ? `承認日: ${document.approvalDate}`
                  : "承認書が見つかりません"}
              </p>
              <Button
                variant="secondary"
                      ...
                      >
                        <div>
                          <p class="text-sm text-gray-500">
                            バージョン <span class="font-medium text-gray-900"
                              >{item.version}</span
                            >
                            by {item.user}
                          </p>
        ...
        <div class="mt-3 text-center">
          ...
          <div class="items-center px-4 py-3">
            <div class="flex space-x-3">
              ...
              <Button variant="danger" size="sm" on:click={deleteDocument}>
                削除する
              </Button>
            </div>
          </div>
