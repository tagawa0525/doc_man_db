...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    ...
    <div class="space-y-6">
        ...
        <div class="p-6">
          ...
          <div class="space-y-3">
            <Button variant="primary" size="md">
              <a href="/documents/new" class="flex items-center w-full">
                <svg class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
                新規文書作成
            ...
            <Button variant="secondary" size="md">
              <a href="/documents" class="flex items-center w-full">
                <svg class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <Button variant="secondary" size="md">
              <a href="/reports" class="flex items-center w-full">
                <svg class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <Button variant="secondary" size="md">
              <a href="/organization" class="flex items-center w-full">
                <svg class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="p-6">
          <h3 class="text-lg font-medium text-gray-900 mb-4">承認待ち文書</h3>
          <div class="space-y-3">
            <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div>
                <p class="text-sm font-medium text-gray-900">システム設計書 v3.0</p>
            ...
            <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div>
                <p class="text-sm font-medium text-gray-900">セキュリティポリシー</p>
