...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
    ...
    <div class="space-y-4 sm:space-y-6">
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="p-4 sm:p-6">
          ...
          <div class="grid grid-cols-2 gap-2 sm:grid-cols-1 sm:gap-3 lg:grid-cols-1">
            ...
            <Button variant="secondary" size="md">
              <a href="/circulations" class="flex items-center justify-center w-full">
                <svg class="mr-1 sm:mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="p-4 sm:p-6">
          <h3 class="text-base sm:text-lg font-medium text-gray-900 mb-3 sm:mb-4">承認待ち回覧</h3>
          <div class="space-y-3">
            <div class="flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 p-3 bg-yellow-50 rounded-lg">
              <div class="min-w-0 flex-1">
                <p class="text-sm font-medium text-gray-900 truncate">システム設計書 v3.0 - 確認</p>
                <p class="text-xs text-gray-500">山田太郎からの回覧 • 2日前</p>
              </div>
              <Button variant="primary" size="sm">
                <a href="/circulations" class="flex items-center">
                  確認
                </a>
              </Button>
            </div>
            <div class="flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 p-3 bg-yellow-50 rounded-lg">
              <div class="min-w-0 flex-1">
                <p class="text-sm font-medium text-gray-900 truncate">セキュリティポリシー - 承認</p>
            ...
            <div class="pt-3 border-t border-gray-200">
              <a href="/circulations" class="text-sm text-blue-600 hover:text-blue-900 font-medium">
                すべての承認待ちを表示
              </a>
            </div>
          </div>
