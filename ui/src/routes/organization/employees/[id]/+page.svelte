<script lang="ts">
  ...
  async function loadEmployee() {
    ...
    try {
      ...
      const emp = employeeId ? mockEmployees[employeeId] : null;
      if (!emp) {
    ...
    try {
      ...
      employee = {
        ...
        department: {
          ...
          name:
            departmentOptions.find((d) => d.value === editFormData.departmentId)
              ?.label || "",
        },
...
<div class="space-y-6">
  ...
  {:else if error}
    ...
    <div class="text-center py-12">
      ...
      <div class="mt-6">
        <Button variant="primary" on:click={loadEmployee}>再読み込み</Button>
      </div>
    </div>
  {:else if employee}
    <!-- 社員詳細 -->
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    id="department"
                    bind:value={editFormData.departmentId}
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    id="joinDate"
                    type="date"
                    bind:value={editFormData.joinDate}
                  />
                </div>
              </div>
                  ...
                  <div class="relative pb-8">
                    ...
                    <div class="relative flex space-x-3">
                      <div>
                        ...
                        >
                          <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getActivityTypeColor(
                              activity.type,
                            )}"
                          >
        ...
        <div class="mt-3 text-center">
          ...
          <div class="items-center px-4 py-3">
            <div class="flex space-x-3">
              ...
              <Button variant="danger" size="sm" on:click={deleteEmployee}>
                削除する
              </Button>
            </div>
          </div>
