...
<div class="space-y-6">
  ...
  <div class="md:flex md:items-center md:justify-between">
    <div class="min-w-0 flex-1">
      ...
      <p class="mt-1 text-sm text-gray-500">部署と社員の管理・権限設定</p>
    </div>
      ...
      {#if activeTab === "departments"}
        ...
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            ...
            <Button variant="primary" size="sm">新規部署追加</Button>
          </div>
          ...
          >
            ...
            <svelte:fragment slot="cell" let:item let:header let:index>
              ...
              {:else if header.key === "managerName"}
                <span class="text-sm text-gray-900">{item.managerName}</span>
              {:else if header.key === "employeeCount"}
              ...
              {:else if header.key === "actions"}
                <div class="flex space-x-2">
                  <button
                    ...
                    on:click={() => console.log("Edit department:", item.id)}
                  >
                    編集
                  </button>
                  <button
                    ...
                    on:click={() =>
                      console.log("Add child department:", item.id)}
                  >
                    子部署追加
                  </button>
                </div>
      ...
      {:else if activeTab === "employees"}
        ...
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            ...
            <Button variant="primary" size="sm">新規社員追加</Button>
          </div>
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-sm text-gray-500">
                        {rootDept.code} | {rootDept.managerName}
                      </p>
                      <p class="text-xs text-gray-400 mt-1">
                        {rootDept.description}
                      </p>
                    </div>
                    <div class="text-right">
                      <div class="text-2xl font-bold text-blue-600">
                        {rootDept.employeeCount}
                      </div>
                      ...
                      >
                        <div class="flex items-center justify-between">
                          <div>
                            ...
                            <p class="text-sm text-gray-500">
                              {childDept.code} | {childDept.managerName}
                            </p>
