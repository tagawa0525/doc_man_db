        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div class="text-center p-4 bg-gray-50 rounded">
            <div class="text-2xl font-bold text-gray-900">
              {validationResult.record_count}
            </div>
            <div class="text-sm text-gray-600">レコード数</div>
          </div>
          <div
            class="text-center p-4 {validationResult.is_valid
              ? 'bg-green-50'
              : 'bg-red-50'} rounded"
          >
            <div
              class="text-2xl font-bold {validationResult.is_valid
                ? 'text-green-600'
                : 'text-red-600'}"
            >
          ...
          <div class="text-center p-4 bg-blue-50 rounded">
            <div class="text-2xl font-bold text-blue-600">
              {validationResult.headers.length}
            </div>
    ...
    {#if importResult}
      <div class="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div class="text-center p-4 bg-blue-50 rounded">
            <div class="text-2xl font-bold text-blue-600">
              {formatDuration(importResult.duration_seconds)}
            </div>
        ...
        <div class="mb-4">
          <p class="text-sm text-gray-600">
            インポートID: <span class="font-mono text-gray-900"
              >{importResult.import_id}</span
            >
          </p>
          <p class="text-sm text-gray-600">
        ...
        {#if importErrors.length > 0}
          <div>
            ...
            <div
              class="max-h-64 overflow-y-auto bg-red-50 border border-red-200 rounded-lg p-4"
            >
              {#each importErrors as error}
                <div class="mb-3 pb-3 border-b border-red-200 last:border-b-0">
                  ...
                  {#if error.raw_data}
                    <div
                      class="text-xs text-red-600 mt-1 font-mono bg-red-100 p-1 rounded"
                    >
                      データ: {error.raw_data}
                    </div>
                  {/if}
                ...
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <span class="text-green-600"
                      >{execution.successful_imports}</span
                    >
                    /
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span
                      class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {execution.status ===
                      'completed'
