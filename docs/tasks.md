...
| **Sprint 5** | Week 9-10  | UI・通知           | Web画面操作        |
| **Sprint 6** | Week 11-12 | 移行・リリース     | 本番データ移行     |
...
| **M4: β版完成**      | Week 10 | UI完成           | エンドユーザー操作可能 |
| **M5: 本番リリース** | Week 12 | 完成版           | 全要件満足・本番稼働   |
