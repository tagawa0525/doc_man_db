...
use crate::models::{
    AdvancedEmployeeSearchInput, EmployeeAutocompleteInput, 
    EmployeeSearchResult, AutocompleteResult, BusinessMember
};
...
impl AdvancedSearchService {
    ...
    pub async fn search_employees_advanced(
        ...
        self.repository.search_employees_advanced(filters, user_permissions).await
    }
    ...
    pub async fn employee_autocomplete(
        ...
        self.repository.employee_autocomplete(input, user_permissions).await
    }
    ...
    /// 検索パラメータのバリデーション
    fn validate_search_parameters(&self, filters: &AdvancedEmployeeSearchInput) -> Result<(), SearchError> {
        // ページネーション検証
...
mod tests {
    ...
    fn test_normalize_search_query() {
        ...
        assert_eq!(normalize_search_query("システム・エンジニア"), "システム エンジニア");
    }
